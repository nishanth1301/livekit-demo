...
function trackTranscriptionObserver(publication) {
  return trackEventSelector(publication, import_livekit_client15.TrackEvent.TranscriptionReceived);
}
function trackSyncTimeObserver(track) {
  return trackEventSelector(track, import_livekit_client15.TrackEvent.TimeSyncUpdate).pipe(
